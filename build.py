...
PEOPLE = [
    ...
    dict(
            ...
            affil2="Cornell Duffield Engineering",
            bio=[
               "Hao Yang is an Ezra Systems Postdoctoral Associate at Cornell University. His research lies at the intersection of public health, GIS, AI, geospatial data science, and urban analytics, with a focus on understanding how human, environmental, healthcare, and urban systems interact to shape population health.",
               "He holds a Ph.D. in Geography from the University of Georgia, with additional training in statistics and global health policy. His work combines large-scale mobility and environmental data, spatial analysis, machine learning, and computational modeling to study infectious disease transmission, human mobility, transportation, environmental health, and One Health. His current research at Cornell focuses on developing data-driven and AI-enabled frameworks that integrate environmental, human, and healthcare information to better understand population health and support health system decision-making."
              ,
            ],
            focus=["Geospatial information science", "Human mobility", "Health systems",
                   "Urban digital twins"],
            meta=[("Office", "Carpenter Hall B1C"),
                  ("Email", '<a href="mailto:hy684@cornell.edu">hy684@cornell.edu</a>'),
                  ("Address", "313 Campus Rd, Ithaca, NY 14853")],
            links=[("Google Scholar", "https://scholar.google.com/citations?user=-kBvjdkAAAAJ&hl=zh-CN")],
        ),
    dict(
        slug="charlle-sy",
        name="Charlle Sy",
    ...
    dict(
                ...
                affil2="Cornell University",
                bio=[
                    "Aryaman Kumar focuses on building intelligent software systems that combine AI, machine learning, and scalable software engineering to solve real-world problems.", 
                    "He is an M.Eng. computer science student at Cornell, where he also serves as a CS 1110 TA and M.Eng. Career Peer Advisor. Before Cornell, he studied computer science, mathematics, and economics at Rutgers University and gained industry experience in AI and machine learning. Most recently at Zensar Technologies, he built an agentic AI system using LLMs, RAG, vector databases, LangChain, and LangGraph, developing multi-agent workflows and backend APIs. His previous work at Tech Mahindra involved fine-tuning and optimizing LLMs, including quantization and QLoRA. His interests center on agentic AI, ML systems, distributed systems, and building reliable AI-powered software at scale.",
                ],
                quote="I’m especially interested in agentic AI, ML systems, and developing AI applications that can operate reliably in real-world environments, so I’m excited to see how those areas connect with the urban digital twin project."
                      ,
                focus=["AI", "Machine Learning", "Software Systems"],
                meta=[("Workstream", "AI Systems — Agents, Machine Learning, Software"),
                      ("Program", "M.Eng. Computer Science, Cornell University"),
                      ("Previously", "Zensar · Tech Mahindra · Rutgers University")],
                links=[],
            ),
    dict(
                slug="jianxiang-gao",
                ...
                affil2="Cornell University",
                bio=[
                    "Jianxiang is a M.Eng student in CS focusing on a broad range of Machine Learning, especially computer vision. He received bachelor degree from Penn State majoring in computational data science, and then he worked as an AI Engineer intern at Mybull Intelligence Machinery to build perception system for autonomous industrial vehicles.", 
                    "He is interested in building, training, and deploying AI to industrial setting and solve real-world problem.",
                ],
                quote="My experiences mostly concentrate on computer vision, and I'm also familiar with other traditional ML and DL. Excited to work in this project!"
                      ,
                focus=["AI", "Machine Learning", "Computer Vision", "Reinforcement Learning"],
                meta=[("Workstream", "Digital Urban Twins - GIS, Spatial Processing, Data Analytics & Integration"),
                      ("Program", "M.Eng. Computer Science, Cornell University"),
    ...
    dict(
                slug="chao-ming-jerry-huang",
                name="Chao Ming (Jerry) Huang",
                short="Chao Ming (Jerry) Huang",
                role="Urban Automation Team",
                group="team",
                group_label="Research Team",
                affil="M.Eng. Computer Science",
                affil2="Cornell University",
                bio=[
                    "Jerry is an M.Eng. Computer Science student at Cornell University and a graduate of the National University of Singapore’s Computer Science program, with a background in machine learning and artificial intelligence. His recent research has explored multilingual information retrieval, dense retrieval, and embedding models.", 
                    "He is interested in applied ML and LLM systems, and is excited to explore how these technologies can be used for geospatial intelligence and real-world urban applications.",
                ],
                quote="I’m especially interested in applied ML, LLM systems, and building AI tools that can solve real-world problems, so I’m excited to explore how these can be applied to urban data and digital twins."
                      ,
                focus=["AI", "Machine Learning", "Multilingual Information Retrieval", "Embedding Models"],
                meta=[("Workstream", "Agentic AI - Data Analytics"),
                      ("Program", "M.Eng. Computer Science, Cornell University"),
                      ("Previously", "Singapore Airlines · A*STAR")],
                links=[],
            ),
    dict(
                slug="chaithat-hom-vanasrisawasd",
                name="Chaithat (Hom) Vanasrisawasd",
                short="Chaithat (Hom) Vanasrisawasd",
                role="Urban Digital Twin Team",
                group="team",
                group_label="Research Team",
                affil="M.Eng. Computer Science",
                affil2="Cornell University",
                bio=[
                    "Chaithat (Hom) Vanasrisawasd is an M.Eng. student in Computer Science at Cornell University, working with AI4C on the Digital Twin track. His interests center on software engineering, AI, and building scalable, data-driven applications.", 
                    "Before Cornell, Hom spent several years as a software engineer working across full-stack development, backend systems, and data infrastructure. He holds a B.A. in Geography and Data Science from the University of Washington. At Cornell, he is interested in expanding his knowledge of AI and exploring how it can be applied alongside his software engineering experience to build real-world systems.",
                ],
                quote="Excited to learn, contribute, and help build the future of urban digital planning."
                      ,
                focus=["AI", "Machine Learning", "Data Infrastructure", "Data Analytics"],
                meta=[("Workstream", "Digital Urban Twins - Spatial Infrastructure, Data Analytics & Integration"),
                      ("Program", "M.Eng. Computer Science, Cornell University"),
                      ("Previously", "Software Engineer at Strike Social and tallad.co")],
                links=[],
            ),
    # dict(
    #             slug="aryaman-kumar",
